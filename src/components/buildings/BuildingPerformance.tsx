        ...
        <div className="space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="bg-green-50 p-6 rounded-lg">
              <h3 className="text-lg font-semibold text-green-700 mb-2">Ingresos del Periodo</h3>
              <p className="text-2xl font-bold text-green-800">$120,000</p>
              <p className="text-sm text-green-600 mt-1">Total de rentas cobradas</p>
            </div>
            <div className="bg-red-50 p-6 rounded-lg">
              <h3 className="text-lg font-semibold text-red-700 mb-2">Gastos del Periodo</h3>
            ...
            <div className="bg-blue-50 p-6 rounded-lg">
              ...
              <p className="text-sm text-blue-600 mt-1">Ingreso Operativo Neto</p>
            </div>
          </div>

          {/* Performance Details */}
          <div className="bg-white p-6 rounded-lg border">
            <h3 className="text-lg font-semibold mb-4">Desglose de Rendimiento</h3>
