      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center">
          <h1 className="text-5xl font-bold text-[#323232] mb-6">
            Simplificamos la gestión de rentas y propiedades
          </h1>
          <p className="text-xl text-gray-600 mb-12 max-w-3xl mx-auto">
            Automatiza cobros, gestiona inquilinos y optimiza tus ingresos con un sistema diseñado para propietarios modernos.
          </p>
