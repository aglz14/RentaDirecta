      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <h2 className="text-4xl font-bold text-[#323232] mb-4">
            Planes Disponibles para tus Inquilinos
          </h2>
          <p className="text-xl text-gray-600">
            Los inquilinos eligen el plan que mejor se adapte a cada una de sus
            propiedades
          </p>
        </div>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-4xl mx-auto">
          <div className="bg-white p-8 rounded-xl custom-shadow payment-option flex flex-col h-full">
            <div className="flex-grow">
              ...
              <p className="text-gray-600 mb-6">
                Pago automático semanal con 3% de descuento
              </p>
          ...
          <div className="bg-white p-8 rounded-xl custom-shadow payment-option flex flex-col h-full">
            <div className="flex-grow">
              ...
              <p className="text-gray-600 mb-6">Pago automático mensual</p>
              <ul className="space-y-4 mb-8">
                <li className="flex items-center text-gray-600">
                  <CheckCircle2 className="h-5 w-5 text-[#00A86B] mr-2" />
                  Recibe la renta completa
                </li>
                <li className="flex items-center text-gray-600">
                  <CheckCircle2 className="h-5 w-5 text-[#00A86B] mr-2" />
                  Pagos automáticos
          ...
          <div className="bg-white p-8 rounded-xl custom-shadow payment-option flex flex-col h-full">
            <div className="flex-grow">
              ...
              <p className="text-gray-600 mb-6">
                Flexibilidad en métodos y fechas de pago
              </p>
              <ul className="space-y-4 mb-8">
                <li className="flex items-center text-gray-600">
                  <CheckCircle2 className="h-5 w-5 text-[#00A86B] mr-2" />
